...
Database.prototype.saveState = function() {
  savedState.data = _.cloneDeep(this.data);
  savedState.counters = _.cloneDeep(this.counters);
};

Database.prototype.restoreState = function() {
  this.data = _.cloneDeep(savedState.data);
  this.counters = _.cloneDeep(savedState.counters);
};
